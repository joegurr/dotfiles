...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Copy commit-msg hook to all Git repositories in a directory."
    )
    parser.add_argument(
        "root_dir", help="The root directory to search for Git repositories."
    )
    parser.add_argument("hook_file", help="The commit-msg hook file to copy.")
    parser.add_argument(
        "--dry-run",
        action="store_true",
        help="Perform a dry run without copying the files.",
    )
